...
const ChatBox: React.FC<Props> = ({ onClose }) => {
    // some state logic
    return (
        <div className="m-4 border-4 flex flex-col gap-2 relative justify-end rounded-2xl bg-white h-[95%] px-4 pb-4">
            ...
            <hr></hr>
            <div className='overflow-y-auto scrollbar-thin flex flex-col gap-2'>
